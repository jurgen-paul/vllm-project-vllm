...
@pytest.mark.parametrize("spatial_merge_size", [2, 3, 4])
def test_qwen2_vl_rot_pos_correctness(spatial_merge_size):
    vision_config = Mock()
...
@pytest.mark.parametrize("spatial_merge_size", [2, 3, 4])
def test_qwen2_5_vl_rot_pos_correctness(spatial_merge_size):
    vision_config = Mock()
    vision_config.spatial_merge_size = spatial_merge_size
...
def test_qwen2_5_vl_get_window_index_correctness(window_size, patch_size, spatial_merge_size):
    vision_config = Mock()
    vision_config.spatial_merge_size = spatial_merge_size
    vision_config.patch_size = patch_size
    vision_config.window_size = window_size
