...
TEST_PARAMS = [
    ...
    TestParams(
        ...
        # commit id: 9cc645141da1210d88bdf8aa5a7f0c725862b1fd
        # tpu: v6e
        expected_avg_time=2.00,
        err_tol=0.20,
    ),
]
    ...
    with monkeypatch.context() as m:
        ...
        with vllm_runner(params.model,
            ...
            for i in range(NUM_WARMUPS):
                _ = vllm_model.generate_greedy(prompts, params.decode_len)
            ...
            assert avg_time - params.expected_avg_time < params.err_tol
