...
from vllm.model_executor.models.skywork_vit import (SkyworkVisionModel,
                                                   SkyworkVisionPatchModel)
    ...
    def _init_vision_model(
        ...
        *,
        ...
        if not is_mono:
            ...
            return SkyworkVisionPatchModel(config.vision_config)
